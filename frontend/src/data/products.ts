  ...
  results: [
    {
      ...
      slug: "espresso",
      description:
        "A concentrated coffee beverage brewed by forcing a small amount of nearly boiling water through finely-ground coffee beans.",
      unit_price: 3,
      discount: 0,
      price: 3,
      media: [
    ...
    },
    {
      ...
      slug: "americano",
      description:
        "Made by diluting espresso with hot water, giving it a similar strength to traditional brewed coffee but with a different flavor profile.",
      unit_price: 4,
      discount: 0,
      price: 4,
      media: [
    ...
    },
    {
      ...
      slug: "latte",
      description:
        "A coffee drink made with espresso and steamed milk, often topped with a small amount of milk foam.",
      unit_price: 5,
      discount: 0,
      price: 5,
      media: [
    ...
    },
    {
      ...
      slug: "cappuccino",
      description:
        "A coffee drink consisting of espresso, steamed milk, and a layer of frothed milk foam on top.",
      unit_price: 7,
      discount: 0,
      price: 7,
      media: [
